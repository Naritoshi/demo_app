...
class Customers(models.Model):
    ...
    pay_0 = models.IntegerField(choices=payment_history, default=1)
    pay_2 = models.IntegerField(choices=payment_history, default=1)
    pay_3 = models.IntegerField(choices=payment_history, default=1)
    pay_4 = models.IntegerField(choices=payment_history, default=1)
    pay_5 = models.IntegerField(choices=payment_history, default=1)
    pay_6 = models.IntegerField(choices=payment_history, default=1)
